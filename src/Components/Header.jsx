...
<nav className='shadow'>
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://sharmaishwor.com.np/" className="flex items-center space-x-3 rtl:space-x-reverse target:">
      <img src={logo} className="h-8 rounded-2xl" alt="Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Genzfy</span>
    </a>
